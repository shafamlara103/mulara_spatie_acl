<?php
// source: phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon
// source: /home/mtake/php_projects/mulara/phpstan.neon
// source: array
...
class Container_c84fb9ffda extends _PHPStan_43cb6abb8\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.stubFilesExtension' => ['027' => true],
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0198' => true],
		'phpstan.rules.rule' => [
			'0269' => true,
			'0270' => true,
			'0271' => true,
	...
	protected $types = ['container' => '_PHPStan_43cb6abb8\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_43cb6abb8\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'093',
				'094',
		...
		'PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule' => [['rules.91']],
		'PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule' => [['rules.92']],
		'PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule' => [['rules.93']],
		'PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule' => [['rules.94']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule' => [['rules.95']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [['rules.96']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [['rules.97']],
		'PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule' => [['rules.98']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['rules.99']],
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['rules.100']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['rules.101']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [['rules.102']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [['rules.103']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [['rules.104']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [['rules.105']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [['rules.106']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [['rules.107']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [['rules.108']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['rules.109']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [['rules.110']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [['rules.111']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [['rules.112']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule' => [['rules.113']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule' => [['rules.114']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [['rules.115']],
		'PHPStan\Rules\Variables\ThrowTypeRule' => [['rules.116']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [['rules.117']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [['rules.118']],
		'PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule' => [['rules.119']],
		'PHPStan\Rules\DeadCode\NoopRule' => [['rules.120']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [['rules.121']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['rules.122']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['rules.123']],
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['rules.124']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['rules.125']],
		'PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule' => [['rules.126']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [['rules.127']],
		'PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule' => [['rules.128']],
		'PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule' => [['rules.129']],
		'PHPStan\Rules\Methods\NullsafeMethodCallRule' => [['rules.130']],
		'PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule' => [['rules.131']],
		'PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule' => [['rules.132']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule' => [['rules.133']],
		'PHPStan\Rules\DateTimeInstantiationRule' => [['rules.134']],
		'PHPStan\Rules\Functions\ImplodeFunctionRule' => [['rules.135']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.136']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.137']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.138']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.139']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.140']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.141']],
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['027']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0156', '0158', '0256', '0262']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0198']],
		...
		'PHPStan\Rules\Classes\MixinRule' => [['0292']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0293']],
		'PHPStan\Rules\Methods\IllegalConstructorMethodCallRule' => [['0294']],
		'PHPStan\Rules\Methods\IllegalConstructorStaticCallRule' => [['0295']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0296']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0297']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0298']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0299']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0300']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0301']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0302']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0303']],
		'PHPStan\Rules\Arrays\ArrayUnpackingRule' => [['0304']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0305']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0306']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0307']],
		'PHPStan\Rules\Comparison\BooleanNotConstantConditionRule' => [['0308']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0309']],
		'PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule' => [['0310']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0311']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0312']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0313']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0314']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0315']],
		'PHPStan\Rules\Comparison\MatchExpressionRule' => [['0316']],
		'PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule' => [['0317']],
		'PHPStan\Rules\Comparison\ConstantLooseComparisonRule' => [['0318']],
		'PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule' => [['0319']],
		'PHPStan\Rules\Comparison\UnreachableIfBranchesRule' => [['0320']],
		'PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule' => [['0321']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule' => [['0322']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule' => [['0323']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule' => [['0324']],
		'PHPStan\Rules\Properties\NullsafePropertyFetchRule' => [['0325']],
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0326']],
		'PHPStan\Rules\Functions\ArrayFilterRule' => [['0327']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'stubFiles' => [
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
			],
			'bootstrapFiles' => [
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
			],
			'excludes_analyse' => [],
			'excludePaths' => ['analyseAndScan' => ['/home/mtake/php_projects/mulara/tests/*/data/*'], 'analyse' => []],
			'level' => 'max',
			'paths' => ['/home/mtake/php_projects/mulara/src', '/home/mtake/php_projects/mulara/tests'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'ignoreErrors' => [
				[
					...
					'count' => 1,
					'path' => '/home/mtake/php_projects/mulara/vendor/canvural/larastan-strict-rules/src/Rules/NoGlobalLaravelFunctionRule.php',
				],
				[
				...
				[
					...
					'count' => 3,
					'path' => '/home/mtake/php_projects/mulara/vendor/canvural/larastan-strict-rules/src/Rules/NoLocalQueryScopeRule.php',
				],
				[
					'message' => '#^Calling PHPStan\\\Reflection\\\Php\\\PhpParameterFromParserNodeReflection\:\:getType\(\) is not covered by backward compatibility promise\. The method might change in a minor PHPStan version\.$#',
					'count' => 3,
					'path' => '/home/mtake/php_projects/mulara/vendor/canvural/larastan-strict-rules/src/Rules/ScopeShouldReturnQueryBuilderRule.php',
				],
			],
			...
			'memoryLimitFile' => '/home/mtake/php_projects/mulara/.build/phpstan/.memory_limit',
			'tempResultCachePath' => '/home/mtake/php_projects/mulara/.build/phpstan/resultCaches',
			'resultCachePath' => '/home/mtake/php_projects/mulara/.build/phpstan/resultCache.php',
			...
			'editorUrl' => null,
			'__validate' => true,
			'tmpDir' => '/home/mtake/php_projects/mulara/.build/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/home/mtake/php_projects/mulara/.build/phpstan',
			'rootDir' => '/home/mtake/php_projects/mulara/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/home/mtake/php_projects/mulara',
			'cliArgumentsVariablesRegistered' => true,
			'additionalConfigFiles' => [
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/mtake/php_projects/mulara/phpstan.neon',
			],
			'composerAutoloaderProjectPaths' => [
				'/home/mtake/php_projects/mulara/vendor/phpstan/phpstan/..',
				'/home/mtake/php_projects/mulara',
			],
	...
	public function createService014(): PHPStan\Php\PhpVersionFactoryFactory
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(
			null,
			['/home/mtake/php_projects/mulara/vendor/phpstan/phpstan/..', '/home/mtake/php_projects/mulara']
		);
	}
	...
	public function createService035(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_c84fb9ffda $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/mtake/php_projects/mulara/.build/phpstan/resultCache.php',
					'/home/mtake/php_projects/mulara/.build/phpstan/resultCaches',
	...
	public function createService047(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/home/mtake/php_projects/mulara',
			'/home/mtake/php_projects/mulara/.build/phpstan',
			[
				'phar:///home/mtake/php_projects/mulara/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'/home/mtake/php_projects/mulara/phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('/home/mtake/php_projects/mulara');
	}
	...
	public function createService053(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('054'),
			[],
			['analyseAndScan' => ['/home/mtake/php_projects/mulara/tests/*/data/*'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Reflection\BetterReflection\SourceLocator\AutoloadSourceLocator($this->getService('065'), false);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0120'), true);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0117'), $this->getService('0118'), true, true, false);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, true);
	}
	...
	{
		return new PHPStan\Rules\Methods\OverridingMethodRule($this->getService('012'), $this->getService('0110'), true);
	}
	...
	public function createService0292(): PHPStan\Rules\Classes\MixinRule
	{
	...
	public function createService0293(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('099'), $this->getService('0120'), true);
	}


	public function createService0294(): PHPStan\Rules\Methods\IllegalConstructorMethodCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorMethodCallRule;
	}


	public function createService0295(): PHPStan\Rules\Methods\IllegalConstructorStaticCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorStaticCallRule;
	}


	public function createService0296(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0297(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule(true);
	}


	public function createService0298(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0299(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0120'), $this->getService('088'), true);
	}


	public function createService0300(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0301(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0302(): PHPStan\Rules\Generators\YieldFromTypeRule
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0120'), true);
	}


	public function createService0303(): PHPStan\Rules\Generators\YieldInGeneratorRule
	{
		return new PHPStan\Rules\Generators\YieldInGeneratorRule(true);
	}


	public function createService0304(): PHPStan\Rules\Arrays\ArrayUnpackingRule
	{
		return new PHPStan\Rules\Arrays\ArrayUnpackingRule($this->getService('012'), $this->getService('0120'));
	}


	public function createService0305(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(false, true);
	}


	public function createService0306(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('090'), true);
	}


	public function createService0307(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('090'), true);
	}


	public function createService0308(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('090'), true);
	}


	public function createService0309(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule($this->getService('0116'), [], [], false);
	}


	public function createService0310(): PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('090'), true);
	}


	public function createService0311(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('090'), true);
	}


	public function createService0312(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('090'), true);
	}


	public function createService0313(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('091'), false, true);
	}


	public function createService0314(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('091'), false, true);
	}


	public function createService0315(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('091'), false, true);
	}


	public function createService0316(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule(false);
	}


	public function createService0317(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule(false);
	}


	public function createService0318(): PHPStan\Rules\Comparison\ConstantLooseComparisonRule
	{
		return new PHPStan\Rules\Comparison\ConstantLooseComparisonRule(false);
	}


	public function createService0319(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('090'), true);
	}


	public function createService0320(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('090'), true);
	}


	public function createService0321(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('090'), true);
	}


	public function createService0322(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('090'), true);
	}


	public function createService0323(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('090'), true);
	}


	public function createService0324(): PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule(false);
	}


	public function createService0325(): PHPStan\Rules\Properties\NullsafePropertyFetchRule
	{
		return new PHPStan\Rules\Properties\NullsafePropertyFetchRule;
	}


	public function createService0326(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
		return new PHPStan\Rules\Functions\RandomIntParametersRule($this->getService('reflectionProvider'), true);
	}


	public function createService0327(): PHPStan\Rules\Functions\ArrayFilterRule
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/home/mtake/php_projects/mulara/.build/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_c84fb9ffda
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderAnalyse'), $this->getService('052'), ['php']);
	}


	public function createServiceFileFinderScan(): PHPStan\File\FileFinder
	{
		return new PHPStan\File\FileFinder($this->getService('fileExcluderScan'), $this->getService('052'), ['php']);
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/home/mtake/php_projects/mulara');
	}
	...
	public function createServiceRules__100(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createServiceRules__101(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0120'), $this->getService('088'));
	}


	public function createServiceRules__102(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0120'));
	}


	public function createServiceRules__103(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0120'));
	}


	public function createServiceRules__104(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0120'));
	}


	public function createServiceRules__105(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0120'));
	}


	public function createServiceRules__106(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0120'));
	}


	public function createServiceRules__107(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule($this->getService('0101'));
	}


	public function createServiceRules__108(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('0101'));
	}


	public function createServiceRules__109(): PHPStan\Rules\Functions\ReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ReturnTypeRule($this->getService('0101'));
	}
	...
	public function createServiceRules__110(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0120'));
	}


	public function createServiceRules__111(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('0101'));
	}


	public function createServiceRules__112(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule($this->getService('0120'));
	}


	public function createServiceRules__113(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule($this->getService('0118'));
	}


	public function createServiceRules__114(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule($this->getService('0118'));
	}


	public function createServiceRules__115(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
	...
	public function createServiceRules__116(): PHPStan\Rules\Variables\ThrowTypeRule
	{
		return new PHPStan\Rules\Variables\ThrowTypeRule($this->getService('0120'));
	}


	public function createServiceRules__117(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0120'));
	}


	public function createServiceRules__118(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__119(): PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule
	{
	...
	public function createServiceRules__120(): PHPStan\Rules\DeadCode\NoopRule
	{
		return new PHPStan\Rules\DeadCode\NoopRule($this->getService('010'));
	}


	public function createServiceRules__121(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
		return new PHPStan\Rules\DeadCode\UnreachableStatementRule;
	}


	public function createServiceRules__122(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0113'));
	}


	public function createServiceRules__123(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule;
	}


	public function createServiceRules__124(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
		return new PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule;
	}


	public function createServiceRules__125(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createServiceRules__126(): PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__127(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__128(): PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule($this->getService('0120'));
	}


	public function createServiceRules__129(): PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule
	{
	...
	public function createServiceRules__130(): PHPStan\Rules\Methods\NullsafeMethodCallRule
	{
		return new PHPStan\Rules\Methods\NullsafeMethodCallRule;
	}


	public function createServiceRules__131(): PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule;
	}


	public function createServiceRules__132(): PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule;
	}


	public function createServiceRules__133(): PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule;
	}


	public function createServiceRules__134(): PHPStan\Rules\DateTimeInstantiationRule
	{
		return new PHPStan\Rules\DateTimeInstantiationRule;
	}


	public function createServiceRules__135(): PHPStan\Rules\Functions\ImplodeFunctionRule
	{
		return new PHPStan\Rules\Functions\ImplodeFunctionRule($this->getService('reflectionProvider'), $this->getService('0120'));
	}


	public function createServiceRules__136(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0111'));
	}


	public function createServiceRules__137(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0111'));
	}


	public function createServiceRules__138(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0111'));
	}


	public function createServiceRules__139(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0111'));
	}
	...
	public function createServiceRules__140(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0111'));
	}


	public function createServiceRules__141(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0111'));
	}
	...
	{
		return new PHPStan\Rules\Classes\UnusedConstructorParametersRule($this->getService('0121'));
	}
	...
	{
		return new PHPStan\Rules\Functions\UnusedClosureUsesRule($this->getService('0121'));
	}


	public function createServiceRules__64(): PHPStan\Rules\Variables\EmptyRule
	{
		return new PHPStan\Rules\Variables\EmptyRule($this->getService('0107'));
	}


	public function createServiceRules__65(): PHPStan\Rules\Variables\IssetRule
	{
		return new PHPStan\Rules\Variables\IssetRule($this->getService('0107'));
	}


	public function createServiceRules__66(): PHPStan\Rules\Variables\NullCoalesceRule
	{
		return new PHPStan\Rules\Variables\NullCoalesceRule($this->getService('0107'));
	}


	public function createServiceRules__67(): PHPStan\Rules\Cast\EchoRule
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0120'));
	}


	public function createServiceRules__68(): PHPStan\Rules\Cast\InvalidCastRule
	{
		return new PHPStan\Rules\Cast\InvalidCastRule($this->getService('reflectionProvider'), $this->getService('0120'));
	}


	public function createServiceRules__69(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('010'), $this->getService('0120'));
	}
	...
	{
		return new PHPStan\Rules\Cast\PrintRule($this->getService('0120'));
	}
	...
	{
		return new PHPStan\Rules\Generics\ClassAncestorsRule($this->getService('0103'), $this->getService('0102'));
	}


	public function createServiceRules__75(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('0105'));
	}


	public function createServiceRules__76(): PHPStan\Rules\Generics\EnumAncestorsRule
	{
		return new PHPStan\Rules\Generics\EnumAncestorsRule($this->getService('0103'), $this->getService('0102'));
	}
	...
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0122'), $this->getService('0105'));
	}


	public function createServiceRules__79(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('0106'));
	}
	...
	{
		return new PHPStan\Rules\Generics\InterfaceAncestorsRule($this->getService('0103'), $this->getService('0102'));
	}


	public function createServiceRules__81(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0105'));
	}


	public function createServiceRules__82(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0122'), $this->getService('0105'));
	}


	public function createServiceRules__83(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('0106'));
	}


	public function createServiceRules__84(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0122'), $this->getService('0105'));
	}


	public function createServiceRules__85(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0122'), $this->getService('0103'));
	}
	...
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('010'), $this->getService('0120'));
	}
	...
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0120'));
	}


	public function createServiceRules__91(): PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule($this->getService('0114'));
	}


	public function createServiceRules__92(): PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule($this->getService('0114'));
	}


	public function createServiceRules__93(): PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('0104'), $this->getService('0115'));
	}


	public function createServiceRules__94(): PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule
	{
	...
	public function createServiceRules__95(): PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule($this->getService('0104'), $this->getService('0115'));
	}


	public function createServiceRules__96(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('015'), $this->getService('018'));
	}


	public function createServiceRules__97(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('015'), $this->getService('018'));
	}


	public function createServiceRules__98(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule($this->getService('0122'));
	}


	public function createServiceRules__99(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0122'));
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/home/mtake/php_projects/mulara');
	}
